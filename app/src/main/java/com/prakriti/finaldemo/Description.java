...
public class Description extends AppCompatActivity {
    ...
    //    Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
      //  setSupportActionBar(toolbar);
        ...
        final ProgressDialog pd = ProgressDialog.show(Description.this, "", "Please wait,Page is Loading...", true);
        pd.show();
        ...
        view.loadData(getString(R.string.hospital_description), "text/html; charset=utf-8", "utf-8");
        pd.dismiss();
                ...
                switch (groupPosition) {
                    case 1:
                        switch (childPosition) {
                            case 0:
                                teaching();
                               Intent myIntent = new Intent(Description.this, Destination.class);
                               startActivity(myIntent);
                               // finish();
                                break;
                            case 1: bnb();
                                Intent myIntent1 = new Intent(Description.this, Destination.class);
                                startActivity(myIntent1);
                                //do something
                                break;
                            case 2: bir();
                                Intent myIntent2 = new Intent(Description.this, Destination.class);
                                startActivity(myIntent2);
                                //do something
                                break;
                            case 3: patan();
                                Intent myIntent3 = new Intent(Description.this, Destination.class);
                                startActivity(myIntent3);
                                //do something
                                break;

                            case 14: vayodha();
                                Intent myIntent5 = new Intent(Description.this, Destination.class);
